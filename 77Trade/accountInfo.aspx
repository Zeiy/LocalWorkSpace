...
<body>
                                            ...
                                            <tr>
                                                <td colspan="2" style="line-height: 24px; font-size: 14px;">
                                                    <table id="RadioButtonList1" border="0">
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton runat="server" ID="isNotBindSecretCard" Text="未绑定" GroupName="bindCard" Checked="true" /></td>
                                                            <td>
                                                                <asp:RadioButton runat="server" ID="isBindSecretCard" Text="已绑定" GroupName="bindCard" /></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                        ...
                                        <table>
                                            <tr>
                                                <td style="line-height: 24px; font-size: 14px;">
                                                    <asp:CheckBox ID="bindIdentityCard" Checked="false" Text="使用身份证" runat="server" />&nbsp;&nbsp;&nbsp;&nbsp; 
    ...
    <div class="footer">
        <div class="fl">
            <img alt="logo" src="global/images/foot_logo1.png" width="113" height="43" />
            <img alt="logo" src="global/images/foot_logo2.png" width="140" height="43" />
        </div>
        <div class="fr">
            <p>
                京ICP备10014751号 京ICP证100162号&nbsp; 京网文[2011]0082-031号&nbsp; 电子商务经营者信息公示<br />
                Copyright © 2010 北京易网合纵网络科技有限公司 All Rights Reserved	版权所有 不得转载
            </p>
        </div>
    </div>
